...
השאילתה מציגה את כל הנסיעות של נהג מסוים ביום מסוים, כולל פרטי המסלול, האוטובוס והסטטוס של כל נסיעה, לצורך הצגה בלוח שנה במערכת. שתי הגרסאות בקובץ [`scripts/Queries.sql`](./scripts/Queries.sql) (בלוק `screen-5.png`, אחרי שאילתות מסך שבע).
...
שאילתות שמציגות למנהל נסיעות לטיפול בבקשות ביטול (`Pending Cancellation`), עם פרטי מסלול ואוטובוס. הקוד ב־[`scripts/Queries.sql`](./scripts/Queries.sql) (בלוק `screen-9.png`).
...
![בקשות ביטול – גרסה 2](queries-images/צילום%20מסך%202026-04-30%20141621.png)
...
![מסך נסיעות כללי – גרסה 1](queries-images/צילום%20מסך%202026-04-30%20145307.png)
