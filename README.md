...
> **הרצה מהירה (הגשה):** [הוראות הפעלה — Docker](#הרצת-הפרויקט-הגשה) · [קובץ `.env.example`](./.env.example)
...
- [**הרצת הפרויקט — Docker (הגשה)**](#הרצת-הפרויקט-הגשה)
...
- [הוראות הפעלה](#הרצת-הפרויקט-הגשה)
- [תמונות מסך](#תמונות-מסך)

### הרצה מהירה (הגשה)
- [הוראות הפעלה — Docker](#הרצת-הפרויקט-הגשה)
...
5. [הוראות הפעלה](#הרצת-הפרויקט-הגשה)
...
> מדריך הרצה מלא — [הרצת הפרויקט (הגשה)](#הרצת-הפרויקט-הגשה) בסוף README.
